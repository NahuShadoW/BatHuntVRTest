...
public class Teleport3 : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	...
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath3"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
