...
public class Teleport4 : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	...
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath4"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
