...
public class Teleport7 : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	...
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath7"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
