...
public class Teleport5 : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	...
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath5"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
