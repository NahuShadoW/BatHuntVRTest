...
public class Teleport2 : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	...
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath2"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
