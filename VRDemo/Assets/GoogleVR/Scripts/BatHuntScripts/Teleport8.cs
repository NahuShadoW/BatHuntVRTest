...
public class Teleport8 : MonoBehaviour, IGvrGazeResponder {
  private Vector3 startingPosition;
	  void Start() {
    startingPosition = transform.localPosition;
    SetGazedAt(false);
	
	iTween.MoveTo(gameObject, iTween.Hash("path", iTweenPath.GetPath("FlyPath8"), "time", 15, "easetype", iTween.EaseType.easeInOutSine));
  }
